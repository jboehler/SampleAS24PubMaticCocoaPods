...
## Integration
PubMatic SDK supports various integration methods, please follow [Developer guide](https://github.com/PubMatic/pubmatic-sdk-ios/wiki) to integrate SDK with your iOS application


License
-------
See the [LICENSE](https://github.com/PubMatic/pubmatic-sdk-ios/blob/master/LICENSE) file.
