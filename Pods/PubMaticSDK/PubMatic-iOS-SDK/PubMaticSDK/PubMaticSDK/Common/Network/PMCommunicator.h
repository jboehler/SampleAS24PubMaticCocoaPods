...
#import "RRFormatterDelegate.h"
@class PMError;

typedef void (^CallBack)(BOOL);

typedef void(^SuccessBlock)(PMAdResponse *adResponse);
typedef void(^ErrorBlock)(PMError * error);

@interface PMCommunicator : NSObject
@property (nonatomic,strong) id<RRFormatterDelegate> rrFormatter;
