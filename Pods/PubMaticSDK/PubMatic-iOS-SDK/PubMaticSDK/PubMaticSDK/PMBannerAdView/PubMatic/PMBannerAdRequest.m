...
@implementation PMBannerAdRequest
...
-(PMError *)validate{
    ...
    if(error == nil && CGSizeEqualToSize(self.adSize, CGSizeZero)
       ){
        
        return [PMError errorWithCode:kPMErrorInvalidRequest description:@"Please provide valid ad size"];
    }
    return error;
}
...
-(NSDictionary *)paramsDictionary{
    ...
    [params setObject:kBannerAdTypeParamValue forKey:kAdTypeParam];
